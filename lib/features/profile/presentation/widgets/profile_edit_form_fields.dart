...
const List<String> civilStatusOptions = [
  'Single',
  'Married',
  'Widowed',
  'Divorced',
...
const List<String> lookingForOptions = [
  'FRIENDSHIP',
  'COMPANIONSHIP',
  'ROMANCE',
  'ACTIVITY_BUDDY',
...
const Map<String, String> lookingForDisplayLabels = {
  ...
  'ROMANCE': 'Romance',
  'ACTIVITY_BUDDY': 'Activity Partner',
};
...
class CivilStatusDropdown extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _LabeledDropdown<String>(
    label: 'Civil status',
    value: civilStatusOptions.contains(selectedStatus) ? selectedStatus : null,
...
class ReligionDropdown extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _LabeledDropdown<String>(
    label: 'Religion',
    value: religionOptions.contains(selectedReligion) ? selectedReligion : null,
...
class ChildrenCountDropdown extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _LabeledDropdown<int>(
    ...
    items: List.generate(
      11,
      (i) => DropdownMenuItem(value: i, child: Text(i == 0 ? 'None' : '$i')),
    ),
  );
}
...
class LookingForSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _ChipSelector(
    allOptions: lookingForOptions,
    selectedValues: selectedValues,
    onChanged: onChanged,
    displayLabel: (option) => lookingForDisplayLabels[option] ?? option,
  );
}
...
class InterestSelector extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => _ChipSelector(
    allOptions: availableInterests,
    selectedValues: selectedInterests,
    onChanged: onChanged,
    displayLabel: (option) => option,
    maxSelections: _maxInterests,
  );
}
