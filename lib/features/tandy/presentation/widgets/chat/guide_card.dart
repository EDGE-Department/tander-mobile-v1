    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          if (_isCompleted) _CompletionView(color: accentColor, onStartOver: _startOver)
          else ...<Widget>[
            _Header(title: widget.title, category: widget.guideData.category, color: accentColor),
...
class _Header extends StatelessWidget {
  const _Header({required this.title, required this.category, required this.color});
  final String title;
    ...
    return Padding(
      ...
      child: Row(
        children: <Widget>[
          ...
          Expanded(
            child: Text(title, style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w800, color: Color(0xFF2D2A26))),
          ),
          Container(
...
class _ProgressBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        height: 3,
        decoration: BoxDecoration(color: const Color(0xFFF0EDE7), borderRadius: BorderRadius.circular(4)),
        child: FractionallySizedBox(
          widthFactor: percent,
          alignment: Alignment.centerLeft,
          child: Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(colors: <Color>[color, color.withAlpha(204)]),
...
class _StepContent extends StatelessWidget {
  const _StepContent({required this.step, required this.stepIndex, required this.totalSteps, required this.color});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text('Step ${stepIndex + 1} of $totalSteps', style: const TextStyle(fontSize: 12, color: Color(0xFF9B8F80), fontWeight: FontWeight.w600)),
          const SizedBox(height: 6),
          Text(step.title, style: const TextStyle(fontSize: 19, fontWeight: FontWeight.w800, color: Color(0xFF2D2A26))),
          const SizedBox(height: 8),
          Text(step.description, style: const TextStyle(fontSize: 15, color: Color(0xFF57534E), height: 1.65)),
        ],
      ),
    );
  }
...
class _Navigation extends StatelessWidget {
  const _Navigation({required this.currentStep, required this.totalSteps, required this.color, required this.onPrevious, required this.onNext});
        ...
        children: <Widget>[
          IconButton(
            ...
            style: IconButton.styleFrom(
              ...
              shape: const CircleBorder(side: BorderSide(color: Color(0xFFE8E3DA))),
          ...
          FilledButton(
            ...
            child: Row(
              children: <Widget>[
                Text(isLast ? 'Finish' : 'Next', style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w700)),
    ...
    return Padding(
      ...
      child: Column(
        children: <Widget>[
          ...
          const Text('All Done!', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800)),
          const SizedBox(height: 6),
          const Text("You've completed this guide. Great job!", style: TextStyle(fontSize: 15, color: Color(0xFF9B8F80))),
          ...
          OutlinedButton(
            ...
            child: const Text('Start Over', style: TextStyle(fontWeight: FontWeight.w700)),
          ),
        ],
      ),
    );
