                  ...
                  Expanded(
                    child: Row(
                      children: <Widget>[
                        ...
                        const Icon(Icons.verified, size: 16, color: kTandyTeal),
                        const SizedBox(width: 6),
                        Container(
                          ...
                          child: Text(
                            sponsorData.sponsorType.toUpperCase(),
                            style: TextStyle(
                              fontSize: 12,
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          ...sponsorData.products.map(
            (product) => _ProductRow(product: product, color: color),
          ),
          if (sponsorData.websiteUrl != null ||
              sponsorData.phoneNumber != null) ...<Widget>[
          ...
          Text(
            ...
            style: const TextStyle(fontSize: 12, color: Color(0xFFC4BBB0)),
          ),
        ],
      ),
    );
