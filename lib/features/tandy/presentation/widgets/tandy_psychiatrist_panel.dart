                ...
                children: [
                  ...
                  Opacity(
                    ...
                    child: ListView(
                      ...
                      children: _sampleDoctors
                          .map((doc) => _DoctorCard(doctor: doc))
                          .toList(),
                    ),
                  ),
                  // Coming Soon overlay
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.person, size: 24, color: kTandyPurple),
          ),
