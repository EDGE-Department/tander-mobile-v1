        ...
        child: Column(
          ...
          children: [
            ...
            Text.rich(TextSpan(children: [
              TextSpan(text: firstName, style: AppTypography.h1.copyWith(color: AppColors.textInverse, fontWeight: FontWeight.w800)),
              if (displayAge != null)
                TextSpan(text: ', $displayAge', style: AppTypography.h1.copyWith(
                  color: AppColors.textInverse.withValues(alpha: 0.8), fontWeight: FontWeight.w600)),
            ])),
  ...
  Widget _onlineBadge() {
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: AppColors.success.withValues(alpha: 0.2), borderRadius: AppRadius.borderFull,
          border: Border.all(color: AppColors.success.withValues(alpha: 0.3))),
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          Container(width: 6, height: 6, decoration: const BoxDecoration(color: AppColors.success, shape: BoxShape.circle)),
          const SizedBox(width: AppSpacing.xxs),
          Text('Online now', style: AppTypography.caption.copyWith(fontSize: 11, fontWeight: FontWeight.w700, color: AppColors.textInverse)),
        ]),
      ),
    );
  }
  ...
  Widget _gradientButton({
    ...
    return GestureDetector(
      ...
      child: Opacity(
        ...
        child: Container(
          constraints: const BoxConstraints(minHeight: AppSpacing.touchMinimum),
          decoration: BoxDecoration(gradient: gradient, borderRadius: AppRadius.borderLg),
          alignment: Alignment.center,
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            Icon(icon, size: 18, color: AppColors.textInverse),
            const SizedBox(width: AppSpacing.xs),
            Text(label, style: AppTypography.label.copyWith(color: AppColors.textInverse, fontWeight: FontWeight.w700)),
          ]),
        ),
      ),
    );
